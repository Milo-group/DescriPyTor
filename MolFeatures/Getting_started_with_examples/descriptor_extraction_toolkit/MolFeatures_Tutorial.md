...
If you want the short version, read the [README](../README.md). If you want the codebase map, read [ARCHITECTURE.md](ARCHITECTURE.md).
...
![Sterimol example](../pictures/sterimol.jpg)

![Ring descriptor example](../pictures/rings.png)
...
![3D atom picker](images/atom-picker.png)
...
![Conformer viewer](images/conformer-viewer.png)
...
- [Getting_started_with_examples/Practical_Notebook_Features.ipynb](../Getting_started_with_examples/Practical_Notebook_Features.ipynb)
- [Getting_started_with_examples/Practical_Notebook_Modeling.ipynb](../Getting_started_with_examples/Practical_Notebook_Modeling.ipynb)
- [Getting_started_with_examples/Full_Analysis_Notebook.ipynb](../Getting_started_with_examples/Full_Analysis_Notebook.ipynb)
- [Getting_started_with_examples/modeling_example/Linear_Dataset_Example.csv](../Getting_started_with_examples/modeling_example/Linear_Dataset_Example.csv)
- [Getting_started_with_examples/modeling_example/Logistic_Dataset_Example.csv](../Getting_started_with_examples/modeling_example/Logistic_Dataset_Example.csv)
